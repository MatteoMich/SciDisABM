...
to re-evaluate
  ...
  set agent-belief initial-belief
...
<experiments>
  ...
  <experiment name="NewGenerationExperimentSpecific" repetitions="200" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>final-result</metric>
    <metric>count turtles with[agent-belief &gt; .99]</metric>
  ...
  <experiment name="NewGenerationExperimentSpecificWithRandomStart1" repetitions="200" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>final-result</metric>
    <metric>count turtles with[agent-belief &gt; .99]</metric>
  ...
  <experiment name="NewGenerationExperimentEvidence" repetitions="200" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>final-result</metric>
    <metric>count turtles with[agent-belief &gt; .99]</metric>
  ...
  <experiment name="ExperimentCorrelationWrongConsensus" repetitions="500" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>final-distribution</metric>
    <metric>count turtles with[agent-belief &gt; .99]</metric>
  ...
  <experiment name="ExperimentCorrelationWrongConsensusFive" repetitions="1000" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>final-result</metric>
    <metric>count turtles with[agent-belief &gt; .99]</metric>
  ...
  <experiment name="ExperimentCorrelationWrongConsensus100" repetitions="1000" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>final-result</metric>
    <metric>count turtles with[agent-belief &gt; .99]</metric>
  ...
  <experiment name="LittleSensAnal" repetitions="100" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>final-result</metric>
    <metric>beliefs</metric>
